###########################################################################
## Makefile generated for component 'STM32InverterCtrl'. 
## 
## Makefile     : STM32InverterCtrl.mk
## Generated on : Tue Jun 16 21:28:55 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/STM32InverterCtrl.elf
...
COMPILER_COMMAND_FILE     = STM32InverterCtrl_comp.rsp
CMD_FILE                  = STM32InverterCtrl.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/STM32InverterCtrl.elf
...
DEFINES_STANDARD = -DMODEL=STM32InverterCtrl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o STM32InverterCtrl.o mw_mbed_interface.o BufferedSerial.o stm32f7xx_init_board.o MW_Timer.o mbed_syscalls.o SysTickScheduler.o m3m4m4f_multitasking.o
...
CPP_LDFLAGS_ = @C:\Users\mrleo\HVDC-R~1\hi\STM32I~1\MBED_O~1.RSP
...
CPP_SHAREDLIB_LDFLAGS_ = @C:\Users\mrleo\HVDC-R~1\hi\STM32I~1\MBED_O~1.RSP
...
LDFLAGS_ = @C:\Users\mrleo\HVDC-R~1\hi\STM32I~1\MBED_O~1.RSP
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m7 -mthumb -mthumb-interwork -mlittle-endian -mfloat-abi=hard -mfpu=fpv5-d16 --entry=Reset_Handler --specs=nano.specs --specs=nosys.specs -T"C:\ProgramData\MATLAB\SupportPackages\R2024b\toolbox\target\supportpackages\stmnucleo\registry\../mbed/NUCLEO_F767ZI/TOOLCHAIN_GCC_ARM/STM32F767xI.ld"
...
SHAREDLIB_LDFLAGS_ = @C:\Users\mrleo\HVDC-R~1\hi\STM32I~1\MBED_O~1.RSP
...
%.o : $(START_DIR)/STM32InverterCtrl_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/STM32InverterCtrl_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/STM32InverterCtrl_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/STM32InverterCtrl_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/STM32InverterCtrl_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
STM32InverterCtrl.o : $(START_DIR)/STM32InverterCtrl_ert_rtw/STM32InverterCtrl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/STM32InverterCtrl_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
